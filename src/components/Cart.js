...
export default function Cart() {
  ...
  return (
    <div>
      <Card.Header as="h3" style={{ fontSize: 30, margin: 40, textAlign: 'center' }}> Selected Items: {bagBooks.length}</Card.Header>
          ...
          <Card bg='light' style={rowStyle}>
            ...
            <Card style={{ textAlign: 'center' }}>
              ...
              <Card.Footer className="text-center">
                <Button variant="primary" onClick={() => dispatch(removeBook(book.title))}>Remove</Button>
              </Card.Footer>
            </Card>
          </Card>
        )}
